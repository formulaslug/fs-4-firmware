...
LTC6811::LTC6811(LTC681xBus& bus, uint8_t id)
    : m_bus(bus), m_id(id) {
...
uint16_t* LTC6811::getVoltages() {
    ...
    m_bus.SendReadCommand(
        LTC681xBus::BuildAddressedBusCommand(ReadCellVoltageGroupA(), m_id), rxbuf
    );
    m_bus.SendReadCommand(
        LTC681xBus::BuildAddressedBusCommand(ReadCellVoltageGroupB(), m_id), rxbuf + 8
    );
    m_bus.SendReadCommand(
        LTC681xBus::BuildAddressedBusCommand(ReadCellVoltageGroupC(), m_id), rxbuf + 16
    );
    m_bus.SendReadCommand(
        LTC681xBus::BuildAddressedBusCommand(ReadCellVoltageGroupD(), m_id), rxbuf + 24
    );
...
uint16_t* LTC6811::getGpio() {
    ...
    m_bus.SendReadCommand(
        LTC681xBus::BuildAddressedBusCommand(ReadAuxiliaryGroupB(), m_id), rxbuf + 8
    );
