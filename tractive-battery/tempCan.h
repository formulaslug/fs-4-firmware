...
class CanGenerator{
    ...
    public:
        uint32_t voltageMessageIds[5] = {BATT_TPDO_MOD0_VOLTS, BATT_TPDO_MOD1_VOLTS, BATT_TPDO_MOD2_VOLTS, BATT_TPDO_MOD3_VOLTS, BATT_TPDO_MOD4_VOLTS};
        uint32_t temperatureMessageIds[10] = {BATT_TPDO_MOD0_TEMPSA, BATT_TPDO_MOD0_TEMPSB, BATT_TPDO_MOD1_TEMPSA, BATT_TPDO_MOD1_TEMPSB, BATT_TPDO_MOD2_TEMPSA, BATT_TPDO_MOD2_TEMPSB, BATT_TPDO_MOD3_TEMPSA, BATT_TPDO_MOD3_TEMPSB, BATT_TPDO_MOD4_TEMPSA, BATT_TPDO_MOD4_TEMPSB};
