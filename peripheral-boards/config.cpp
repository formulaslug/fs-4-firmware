...
Corner readCorner()
{
    ...
    switch(val) 
    {
        case 0: return Corner::FR;
        case 1: return Corner::FL;
        case 2: return Corner::BR;
        case 3: return Corner::BL;
        default: return Corner::FR; //Might want to add something for an invald position
    }
}
