...
private:
	...
	bool waitForPacket(int channel, uint8_t reportID, std::chrono::milliseconds timeout = std::chrono::milliseconds(125)) override;
...
typedef BNO080Async BNO08xAsync;
typedef BNO080Async BNO086Async;
