...
rpmArray = runDataDF["SME_TRQSPD_Speed"].to_numpy()
...
C_KALMAN_FUNC = "../src/testRunKalman"
 
KALMAN_INITIAL_SOC        = 48.0   
...
currentPlot = host_subplot(312)
currentPlotParasite = currentPlot.twinx()
currentPlot.plot(indexArray, currentConverted, label="Current")
currentPlot.plot(indexArray, rpmArray, label="RPM", color="orange")
...
currentPlot.set_ylabel("Current (mA) & RPM")
currentPlotParasite.set_ylabel("SOC %")
